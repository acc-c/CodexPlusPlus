...
type Route = "overview" | "relay" | "grok" | "relayEnvironment" | "sessions" | "context" | "skills" | "weixin" | "enhance" | "dreamSkin" | "taskboard" | "zedRemote" | "userScripts" | "recommendations" | "maintenance" | "about" | "settings";
        ...
        <nav className="nav" aria-label={t("主导航")}>
          {navigationSections.map((section) => (
            <div className={`nav-section ${section.placement === "bottom" ? "nav-section-bottom" : ""}`} key={section.label}>
              ...
              {section.routes.filter((routeId) => routeId !== "taskboard" || taskboardEnabled).map((routeId) => {
